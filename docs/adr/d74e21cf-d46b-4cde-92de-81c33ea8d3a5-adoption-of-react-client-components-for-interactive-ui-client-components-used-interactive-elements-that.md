...
1. SHOULD: Client Components SHOULD be used for interactive UI elements that require browser APIs, event listeners, or React Hooks like useState or useEffect.

## Policy Block

- SHOULD Client Components SHOULD be used for interactive UI elements that require browser APIs, event listeners, or React Hooks like useState or useEffect.
