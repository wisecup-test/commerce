...
1. MUST: All async server actions that perform cart mutations, external API calls, or webhook processing MUST log caught exceptions to the console error stream

## Policy Block

- MUST All async server actions that perform cart mutations, external API calls, or webhook processing MUST log caught exceptions to the console error stream
