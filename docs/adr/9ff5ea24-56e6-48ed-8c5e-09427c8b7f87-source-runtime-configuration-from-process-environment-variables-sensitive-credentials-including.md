...
1. MUST: Sensitive credentials including API tokens, access keys, and authentication secrets MUST be accessed exclusively through environment variables and MUST NOT be hardcoded in source files.

## Policy Block

- MUST Sensitive credentials including API tokens, access keys, and authentication secrets MUST be accessed exclusively through environment variables and MUST NOT be hardcoded in source files.
