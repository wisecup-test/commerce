...
1. MUST: Before implementing any code that uses a versioned library, the consumer MUST discover the ecosystem's lock file and resolve the exact locked version.

## Policy Block

- MUST Before implementing any code that uses a versioned library, the consumer MUST discover the ecosystem's lock file and resolve the exact locked version.
