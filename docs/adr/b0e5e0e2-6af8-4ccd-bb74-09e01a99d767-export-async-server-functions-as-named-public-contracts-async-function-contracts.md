...
1. SHOULD: Async function contracts SHOULD separate concerns by delegating to internal helper functions for data access, external service calls, and transformation logic.

## Policy Block

- SHOULD Async function contracts SHOULD separate concerns by delegating to internal helper functions for data access, external service calls, and transformation logic.
