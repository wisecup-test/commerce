...
1. SHOULD_NOT: Client Components SHOULD NOT be used for purely static or server-rendered UI parts to maximize server-side rendering benefits.

## Policy Block

- SHOULD_NOT Client Components SHOULD NOT be used for purely static or server-rendered UI parts to maximize server-side rendering benefits.
