...
1. MUST: The project MUST log errors using `console.error` for critical failures during Shopify API operations.

## Policy Block

- MUST The project MUST log errors using `console.error` for critical failures during Shopify API operations.
