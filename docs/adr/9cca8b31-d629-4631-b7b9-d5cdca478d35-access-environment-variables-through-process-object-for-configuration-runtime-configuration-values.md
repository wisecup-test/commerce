...
1. MUST: All runtime configuration values including credentials SHALL be accessed through the process object's environment property

## Policy Block

- MUST All runtime configuration values including credentials SHALL be accessed through the process object's environment property
