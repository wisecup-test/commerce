...
1. MUST: Configuration validation failures must be logged using console error output to provide visibility into misconfiguration at request time

## Policy Block

- MUST Configuration validation failures must be logged using console error output to provide visibility into misconfiguration at request time
