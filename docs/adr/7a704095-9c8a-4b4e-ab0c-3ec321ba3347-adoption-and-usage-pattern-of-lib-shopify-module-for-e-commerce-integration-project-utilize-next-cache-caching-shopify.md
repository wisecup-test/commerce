# Adoption and Usage Pattern of `lib/shopify` Module for E-commerce Integration: Project Utilize Next Cache Caching Shopify
...
1. SHOULD: The project SHOULD utilize `next/cache` for caching Shopify-related data to optimize performance.

## Policy Block

- SHOULD The project SHOULD utilize `next/cache` for caching Shopify-related data to optimize performance.
