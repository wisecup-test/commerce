...
1. MUST: Server action functions that mutate state SHALL be exported as async functions and coordinate cache invalidation, cookie management, and error handling within their scope.

## Policy Block

- MUST Server action functions that mutate state SHALL be exported as async functions and coordinate cache invalidation, cookie management, and error handling within their scope.
