...
1. SHOULD: Ensure that `fragments` modules contain only definitions intended for reuse and do not include operational logic.

## Policy Block

- SHOULD Ensure that `fragments` modules contain only definitions intended for reuse and do not include operational logic.
