...
1. MUST: Import shared cart-related components from the `fragments/cart` module using relative paths within the `lib/shopify` module.

## Policy Block

- MUST Import shared cart-related components from the `fragments/cart` module using relative paths within the `lib/shopify` module.
