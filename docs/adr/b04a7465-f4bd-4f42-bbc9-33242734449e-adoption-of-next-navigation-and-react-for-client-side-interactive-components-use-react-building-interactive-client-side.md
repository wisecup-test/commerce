...
1. MUST: Use `react` for building interactive client-side user interface components.

## Policy Block

- MUST Use `react` for building interactive client-side user interface components.
