...
1. MUST: MUST discover the ecosystem's lock file or resolution artifact to determine the exact resolved version of the framework before implementing solutions that rely on its specific API behavior.

## Policy Block

- MUST MUST discover the ecosystem's lock file or resolution artifact to determine the exact resolved version of the framework before implementing solutions that rely on its specific API behavior.
