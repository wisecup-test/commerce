...
1. MUST: Shopify API credentials and revalidation secrets MUST be managed exclusively through environment variables.

## Policy Block

- MUST Shopify API credentials and revalidation secrets MUST be managed exclusively through environment variables.
