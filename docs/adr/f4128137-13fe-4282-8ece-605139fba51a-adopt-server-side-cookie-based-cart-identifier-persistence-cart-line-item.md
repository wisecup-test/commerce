...
1. MUST: Cart line item queries MUST use merchandise identifier-based lookup to locate existing items within the cart collection

## Policy Block

- MUST Cart line item queries MUST use merchandise identifier-based lookup to locate existing items within the cart collection
