...
1. MUST: Cart creation operations MUST atomically persist the cart identifier to cookie storage immediately after successful cart instantiation

## Policy Block

- MUST Cart creation operations MUST atomically persist the cart identifier to cookie storage immediately after successful cart instantiation
