...
1. SHOULD: When the find result is used in a conditional context, the code should use nullish coalescing or logical OR operators to provide fallback values

## Policy Block

- SHOULD When the find result is used in a conditional context, the code should use nullish coalescing or logical OR operators to provide fallback values
