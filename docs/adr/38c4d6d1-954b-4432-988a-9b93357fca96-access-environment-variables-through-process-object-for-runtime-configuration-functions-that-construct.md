...
1. MUST: Functions that construct external HTTP requests with authentication headers must retrieve credential values from the process environment at the point of use

## Policy Block

- MUST Functions that construct external HTTP requests with authentication headers must retrieve credential values from the process environment at the point of use
