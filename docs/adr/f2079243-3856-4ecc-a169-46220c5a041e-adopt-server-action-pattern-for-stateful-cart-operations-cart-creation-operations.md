...
1. MUST: Cart creation operations MUST atomically persist the cart identifier to the session cookie layer immediately after successful creation.

## Policy Block

- MUST Cart creation operations MUST atomically persist the cart identifier to the session cookie layer immediately after successful creation.
