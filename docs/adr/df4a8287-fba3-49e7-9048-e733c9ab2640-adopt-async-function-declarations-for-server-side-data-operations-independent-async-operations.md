...
1. SHOULD: Independent async operations that do not depend on each other's results SHOULD be initiated in parallel and awaited together to minimize latency.

## Policy Block

- SHOULD Independent async operations that do not depend on each other's results SHOULD be initiated in parallel and awaited together to minimize latency.
