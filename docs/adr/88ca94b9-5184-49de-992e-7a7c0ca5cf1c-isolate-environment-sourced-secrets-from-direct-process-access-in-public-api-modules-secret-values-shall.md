...
1. MUST: Secret values shall be validated for presence and format at configuration initialization time, not at point of use within API request handlers or component render paths.

## Policy Block

- MUST Secret values shall be validated for presence and format at configuration initialization time, not at point of use within API request handlers or component render paths.
