...
1. SHOULD: Configuration validation SHOULD occur at application initialization to fail fast when required values are missing or malformed.

## Policy Block

- SHOULD Configuration validation SHOULD occur at application initialization to fail fast when required values are missing or malformed.
