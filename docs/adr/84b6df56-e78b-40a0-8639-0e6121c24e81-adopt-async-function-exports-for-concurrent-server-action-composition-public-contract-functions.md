...
1. MUST: All public API contract functions that perform I/O operations (external HTTP requests, cache mutations, cookie/header access) must be exported as async functions.

## Policy Block

- MUST All public API contract functions that perform I/O operations (external HTTP requests, cache mutations, cookie/header access) must be exported as async functions.
