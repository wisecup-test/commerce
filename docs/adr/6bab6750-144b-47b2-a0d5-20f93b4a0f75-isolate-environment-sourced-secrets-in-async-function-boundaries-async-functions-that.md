...
1. MUST: All async functions that access environment-sourced secrets MUST validate secret presence and format before using them in external calls or header construction.

## Policy Block

- MUST All async functions that access environment-sourced secrets MUST validate secret presence and format before using them in external calls or header construction.
