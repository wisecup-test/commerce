...
1. MAY: Configuration values may be validated at request time when used in webhook or callback handlers that execute conditionally

## Policy Block

- MAY Configuration values may be validated at request time when used in webhook or callback handlers that execute conditionally
