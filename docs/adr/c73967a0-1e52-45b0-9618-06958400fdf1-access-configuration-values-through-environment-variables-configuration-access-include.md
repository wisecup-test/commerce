...
1. MAY: Configuration access MAY include fallback values or default assignments when appropriate for non-sensitive settings

## Policy Block

- MAY Configuration access MAY include fallback values or default assignments when appropriate for non-sensitive settings
