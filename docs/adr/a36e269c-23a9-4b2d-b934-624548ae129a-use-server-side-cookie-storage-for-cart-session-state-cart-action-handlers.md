...
1. MUST: All cart action handlers MUST be declared as async functions to support awaited cookie operations.

## Policy Block

- MUST All cart action handlers MUST be declared as async functions to support awaited cookie operations.
