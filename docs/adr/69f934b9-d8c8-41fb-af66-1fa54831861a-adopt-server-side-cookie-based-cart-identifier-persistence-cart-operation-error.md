...
1. SHOULD: Cart operation error conditions SHOULD log diagnostic information to the console error stream

## Policy Block

- SHOULD Cart operation error conditions SHOULD log diagnostic information to the console error stream
