...
1. MUST: Cart management operations that modify state or trigger side effects MUST be implemented as async functions.

## Policy Block

- MUST Cart management operations that modify state or trigger side effects MUST be implemented as async functions.
