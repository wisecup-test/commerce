...
1. SHOULD: Developers SHOULD prioritize the composition of existing utility classes over the introduction of custom CSS for common styling requirements.

## Policy Block

- SHOULD Developers SHOULD prioritize the composition of existing utility classes over the introduction of custom CSS for common styling requirements.
