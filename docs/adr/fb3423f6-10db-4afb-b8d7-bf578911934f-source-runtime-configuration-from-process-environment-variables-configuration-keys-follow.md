...
1. SHOULD: Configuration keys SHOULD follow a consistent naming convention that groups related values by functional domain or service boundary.

## Policy Block

- SHOULD Configuration keys SHOULD follow a consistent naming convention that groups related values by functional domain or service boundary.
