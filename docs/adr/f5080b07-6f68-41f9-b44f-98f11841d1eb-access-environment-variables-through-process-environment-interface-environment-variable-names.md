...
1. SHOULD: Environment variable names SHOULD follow uppercase snake_case naming convention with domain-specific prefixes

## Policy Block

- SHOULD Environment variable names SHOULD follow uppercase snake_case naming convention with domain-specific prefixes
