...
1. MUST: External service credentials SHALL be sourced exclusively from environment variables accessed through the runtime process environment interface.

## Policy Block

- MUST External service credentials SHALL be sourced exclusively from environment variables accessed through the runtime process environment interface.
