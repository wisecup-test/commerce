...
1. MUST: Secret values SHALL NOT be committed to version control, embedded as string literals in source code, or logged to standard output or error streams.

## Policy Block

- MUST Secret values SHALL NOT be committed to version control, embedded as string literals in source code, or logged to standard output or error streams.
