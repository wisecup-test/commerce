...
1. MUST_NOT: Environment variables containing secrets SHALL NOT be accessed in client-side execution contexts

## Policy Block

- MUST_NOT Environment variables containing secrets SHALL NOT be accessed in client-side execution contexts
