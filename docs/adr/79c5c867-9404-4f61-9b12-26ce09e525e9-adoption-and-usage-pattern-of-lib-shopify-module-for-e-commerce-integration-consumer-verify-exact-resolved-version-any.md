...
1. MUST: The consumer MUST verify the exact resolved version of any versioned dependency before implementation by inspecting the project's lock file or resolution artifact.

## Policy Block

- MUST The consumer MUST verify the exact resolved version of any versioned dependency before implementation by inspecting the project's lock file or resolution artifact.
