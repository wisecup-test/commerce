...
1. MUST: All server-side functions that perform I/O operations MUST be declared as async functions and return Promises.

## Policy Block

- MUST All server-side functions that perform I/O operations MUST be declared as async functions and return Promises.
