# Adoption of React Client Components for Interactive UI: Server Rendered Data Passed Props Client
...
1. MAY: Server-rendered data MAY be passed as props to Client Components.

## Policy Block

- MAY Server-rendered data MAY be passed as props to Client Components.
