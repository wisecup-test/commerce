...
1. MAY: Handlers MAY supplement console logging with structured observability when available

## Policy Block

- MAY Handlers MAY supplement console logging with structured observability when available
