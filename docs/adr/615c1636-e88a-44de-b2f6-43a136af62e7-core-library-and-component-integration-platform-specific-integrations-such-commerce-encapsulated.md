...
1. MUST: Platform-specific integrations, such as e-commerce APIs, MUST be encapsulated within dedicated library modules.

## Policy Block

- MUST Platform-specific integrations, such as e-commerce APIs, MUST be encapsulated within dedicated library modules.
