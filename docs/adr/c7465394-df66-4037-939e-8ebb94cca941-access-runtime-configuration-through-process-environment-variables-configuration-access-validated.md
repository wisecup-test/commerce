...
1. SHOULD: Configuration access SHOULD be validated or provide fallback values when values are optional

## Policy Block

- SHOULD Configuration access SHOULD be validated or provide fallback values when values are optional
