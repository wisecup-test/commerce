...
1. MUST: All environment-sourced secrets required by public API modules shall be retrieved through a dedicated configuration abstraction layer that isolates direct process environment access from API contract implementations.

## Policy Block

- MUST All environment-sourced secrets required by public API modules shall be retrieved through a dedicated configuration abstraction layer that isolates direct process environment access from API contract implementations.
