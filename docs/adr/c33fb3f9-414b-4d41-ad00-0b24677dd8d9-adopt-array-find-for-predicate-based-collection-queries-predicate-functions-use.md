...
1. SHOULD: Predicate functions should use property access patterns that match the structure of the collection elements without intermediate destructuring

## Policy Block

- SHOULD Predicate functions should use property access patterns that match the structure of the collection elements without intermediate destructuring
