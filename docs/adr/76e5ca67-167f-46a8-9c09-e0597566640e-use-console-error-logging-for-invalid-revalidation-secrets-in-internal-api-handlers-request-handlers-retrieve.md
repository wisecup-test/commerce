...
1. MUST: Request handlers MUST retrieve cache identifiers from cookies and topic identifiers from headers before validation

## Policy Block

- MUST Request handlers MUST retrieve cache identifiers from cookies and topic identifiers from headers before validation
