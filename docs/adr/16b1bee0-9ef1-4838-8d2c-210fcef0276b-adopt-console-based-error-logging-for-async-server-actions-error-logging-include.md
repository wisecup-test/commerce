...
1. MAY: Error logging MAY include contextual information about the operation being performed when the error occurred

## Policy Block

- MAY Error logging MAY include contextual information about the operation being performed when the error occurred
