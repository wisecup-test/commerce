...
1. MUST: All public cart operation contracts MUST be exported as named async functions from the module boundary.

## Policy Block

- MUST All public cart operation contracts MUST be exported as named async functions from the module boundary.
