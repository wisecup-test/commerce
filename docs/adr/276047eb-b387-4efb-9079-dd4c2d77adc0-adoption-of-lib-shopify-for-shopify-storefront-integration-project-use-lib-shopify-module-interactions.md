...
1. MUST: The project MUST use the `lib/shopify` module for all interactions with the Shopify Storefront API.

## Policy Block

- MUST The project MUST use the `lib/shopify` module for all interactions with the Shopify Storefront API.
