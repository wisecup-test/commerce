...
1. MUST: Secret validation logic MUST extract comparison values from runtime environment configuration

## Policy Block

- MUST Secret validation logic MUST extract comparison values from runtime environment configuration
