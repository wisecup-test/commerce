...
1. MUST: MUST discover the project's dependency manifest and lock file to determine the exact resolved version of `next/image` before implementation.

## Policy Block

- MUST MUST discover the project's dependency manifest and lock file to determine the exact resolved version of `next/image` before implementation.
