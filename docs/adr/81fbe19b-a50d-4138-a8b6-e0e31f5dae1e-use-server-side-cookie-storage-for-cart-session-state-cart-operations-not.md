...
1. MUST_NOT: Cart operations MUST NOT assume synchronous access to session state or block on cookie I/O.

## Policy Block

- MUST_NOT Cart operations MUST NOT assume synchronous access to session state or block on cookie I/O.
