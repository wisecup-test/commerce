...
1. MUST: All predicate-based queries for a single element in an in-memory collection must use the native find method with an inline predicate function

## Policy Block

- MUST All predicate-based queries for a single element in an in-memory collection must use the native find method with an inline predicate function
