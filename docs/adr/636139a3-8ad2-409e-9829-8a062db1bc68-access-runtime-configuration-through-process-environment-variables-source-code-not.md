...
1. MUST_NOT: Source code MUST NOT contain hardcoded values for credentials, API keys, deployment URLs, or environment-specific endpoints that should be externalized to process environment configuration.

## Policy Block

- MUST_NOT Source code MUST NOT contain hardcoded values for credentials, API keys, deployment URLs, or environment-specific endpoints that should be externalized to process environment configuration.
