...
1. MUST: The project MUST retrieve environment variables for Shopify API credentials via `process.env`.

## Policy Block

- MUST The project MUST retrieve environment variables for Shopify API credentials via `process.env`.
