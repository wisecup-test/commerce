...
1. MUST: Before implementing any code that relies on environment variables, the developer MUST discover the project's dependency manifest and lock file to determine the exact runtime environment version and consult its official documentation for environment variable handling.

## Policy Block

- MUST Before implementing any code that relies on environment variables, the developer MUST discover the project's dependency manifest and lock file to determine the exact runtime environment version and consult its official documentation for environment variable handling.
