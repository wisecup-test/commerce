...
1. MUST: Before implementing code that depends on versioned framework or library APIs, the consumer MUST discover the project's dependency lock artifact, resolve the exact installed version, and verify API compatibility against that version's official documentation

## Policy Block

- MUST Before implementing code that depends on versioned framework or library APIs, the consumer MUST discover the project's dependency lock artifact, resolve the exact installed version, and verify API compatibility against that version's official documentation
