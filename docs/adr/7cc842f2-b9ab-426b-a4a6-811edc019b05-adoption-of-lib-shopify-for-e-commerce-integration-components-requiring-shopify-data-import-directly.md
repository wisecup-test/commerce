...
1. SHOULD: Components requiring Shopify data SHOULD import directly from `lib/shopify` or its sub-modules (e.g., `lib/shopify/types`).

## Policy Block

- SHOULD Components requiring Shopify data SHOULD import directly from `lib/shopify` or its sub-modules (e.g., `lib/shopify/types`).
