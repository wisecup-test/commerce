...
1. MUST: The project MUST utilize the Next.js framework for all new web application development.

## Policy Block

- MUST The project MUST utilize the Next.js framework for all new web application development.
