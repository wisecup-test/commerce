...
1. SHOULD: SHOULD configure `next/image` with appropriate `width`, `height`, `alt`, and `priority` properties for optimal performance and accessibility.

## Policy Block

- SHOULD SHOULD configure `next/image` with appropriate `width`, `height`, `alt`, and `priority` properties for optimal performance and accessibility.
