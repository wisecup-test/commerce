...
1. MUST: Discover the ecosystem's lock file and resolve the exact locked version of any versioned dependency before implementation.

## Policy Block

- MUST Discover the ecosystem's lock file and resolve the exact locked version of any versioned dependency before implementation.
