...
1. SHOULD: Encapsulate client-side logic and state within components marked with "use client".

## Policy Block

- SHOULD Encapsulate client-side logic and state within components marked with "use client".
