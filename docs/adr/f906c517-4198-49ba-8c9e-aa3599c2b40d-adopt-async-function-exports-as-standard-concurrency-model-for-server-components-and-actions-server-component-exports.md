...
1. MUST: All server component exports that perform data fetching, external API calls, or file system operations MUST be declared as async functions

## Policy Block

- MUST All server component exports that perform data fetching, external API calls, or file system operations MUST be declared as async functions
