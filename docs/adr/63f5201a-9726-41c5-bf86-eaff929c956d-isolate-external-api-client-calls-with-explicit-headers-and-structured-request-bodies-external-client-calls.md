...
1. MUST: External API client calls MUST construct HTTP requests with explicit method, headers object, and body serialization.

## Policy Block

- MUST External API client calls MUST construct HTTP requests with explicit method, headers object, and body serialization.
