...
1. SHOULD: Modules that consume environment variables SHOULD validate the presence and format of required configuration values at initialization

## Policy Block

- SHOULD Modules that consume environment variables SHOULD validate the presence and format of required configuration values at initialization
