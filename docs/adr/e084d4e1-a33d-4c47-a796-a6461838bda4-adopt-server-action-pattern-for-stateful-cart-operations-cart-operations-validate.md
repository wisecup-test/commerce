...
1. SHOULD: Cart operations SHOULD validate merchandise identifiers against existing cart line items before performing mutations.

## Policy Block

- SHOULD Cart operations SHOULD validate merchandise identifiers against existing cart line items before performing mutations.
