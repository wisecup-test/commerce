...
1. MUST_NOT: Source code SHALL NOT contain hardcoded credentials, API keys, tokens, or other sensitive configuration values

## Policy Block

- MUST_NOT Source code SHALL NOT contain hardcoded credentials, API keys, tokens, or other sensitive configuration values
