...
1. MUST: All styling applied via utility classes MUST adhere to the established design system conventions, including support for responsive breakpoints and theme variations.

## Policy Block

- MUST All styling applied via utility classes MUST adhere to the established design system conventions, including support for responsive breakpoints and theme variations.
