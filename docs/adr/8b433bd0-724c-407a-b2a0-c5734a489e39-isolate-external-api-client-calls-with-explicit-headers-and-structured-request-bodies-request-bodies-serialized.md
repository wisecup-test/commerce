...
1. MUST: Request bodies MUST be serialized as JSON with conditional field inclusion based on presence of query and variables parameters.

## Policy Block

- MUST Request bodies MUST be serialized as JSON with conditional field inclusion based on presence of query and variables parameters.
