...
1. MAY: Utility functions MAY provide validation or transformation of environment configuration values

## Policy Block

- MAY Utility functions MAY provide validation or transformation of environment configuration values
