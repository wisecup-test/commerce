...
1. SHOULD: Modules that consume multiple related configuration values SHOULD encapsulate environment access in dedicated configuration retrieval functions.

## Policy Block

- SHOULD Modules that consume multiple related configuration values SHOULD encapsulate environment access in dedicated configuration retrieval functions.
