...
1. SHOULD: Configuration variable names SHOULD use uppercase naming with underscore separators to distinguish them from code-level identifiers

## Policy Block

- SHOULD Configuration variable names SHOULD use uppercase naming with underscore separators to distinguish them from code-level identifiers
