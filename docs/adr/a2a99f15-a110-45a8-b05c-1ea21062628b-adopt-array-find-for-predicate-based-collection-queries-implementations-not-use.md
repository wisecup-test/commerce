...
1. MUST_NOT: Implementations must not use imperative for-loops or while-loops for single-element predicate queries where find is applicable

## Policy Block

- MUST_NOT Implementations must not use imperative for-loops or while-loops for single-element predicate queries where find is applicable
