...
1. MUST_NOT: Configuration values MUST NOT be logged, serialized to client-side code, or exposed through public API responses unless explicitly intended for public consumption.

## Policy Block

- MUST_NOT Configuration values MUST NOT be logged, serialized to client-side code, or exposed through public API responses unless explicitly intended for public consumption.
