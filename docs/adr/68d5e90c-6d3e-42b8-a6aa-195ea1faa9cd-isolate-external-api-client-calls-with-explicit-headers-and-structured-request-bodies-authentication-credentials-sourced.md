...
1. MUST: Authentication credentials MUST be sourced from runtime configuration and injected into request headers, never hardcoded in client logic.

## Policy Block

- MUST Authentication credentials MUST be sourced from runtime configuration and injected into request headers, never hardcoded in client logic.
