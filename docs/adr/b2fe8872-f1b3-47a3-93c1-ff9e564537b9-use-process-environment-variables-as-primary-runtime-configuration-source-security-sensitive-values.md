...
1. MUST: Security-sensitive values including access tokens, API keys, and secrets SHALL be sourced exclusively from process environment variables and never hardcoded

## Policy Block

- MUST Security-sensitive values including access tokens, API keys, and secrets SHALL be sourced exclusively from process environment variables and never hardcoded
