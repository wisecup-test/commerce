...
1. MUST: Developers MUST verify the exact resolved version of any versioned dependency by inspecting the project's lock file before implementation.

## Policy Block

- MUST Developers MUST verify the exact resolved version of any versioned dependency by inspecting the project's lock file before implementation.
