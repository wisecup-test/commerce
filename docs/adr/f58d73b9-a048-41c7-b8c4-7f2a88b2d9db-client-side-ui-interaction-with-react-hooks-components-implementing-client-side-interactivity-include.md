# Client-Side UI Interaction with React Hooks: Components Implementing Client Side Interactivity Include
...
1. MUST: Components implementing client-side interactivity MUST include the `use client` directive.

## Policy Block

- MUST Components implementing client-side interactivity MUST include the `use client` directive.
