...
1. SHOULD: Environment variable names for secrets SHOULD follow a consistent naming convention that clearly identifies the external service and credential type.

## Policy Block

- SHOULD Environment variable names for secrets SHOULD follow a consistent naming convention that clearly identifies the external service and credential type.
