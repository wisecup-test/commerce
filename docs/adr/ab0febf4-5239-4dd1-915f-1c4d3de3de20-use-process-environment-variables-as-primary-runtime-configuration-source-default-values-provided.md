...
1. MAY: Default values MAY be provided for non-critical configuration using object spread patterns when environment variables are undefined

## Policy Block

- MAY Default values MAY be provided for non-critical configuration using object spread patterns when environment variables are undefined
