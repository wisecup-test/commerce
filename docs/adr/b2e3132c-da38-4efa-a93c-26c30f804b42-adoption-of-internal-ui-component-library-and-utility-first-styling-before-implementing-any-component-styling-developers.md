...
1. MUST: Before implementing any UI component or styling, developers MUST verify the exact resolved versions of all relevant dependencies by inspecting the project's lock file.

## Policy Block

- MUST Before implementing any UI component or styling, developers MUST verify the exact resolved versions of all relevant dependencies by inspecting the project's lock file.
