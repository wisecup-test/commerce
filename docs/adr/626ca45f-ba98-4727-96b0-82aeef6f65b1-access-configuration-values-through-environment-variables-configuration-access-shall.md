...
1. MUST: Configuration access SHALL use the standard process environment property accessor pattern

## Policy Block

- MUST Configuration access SHALL use the standard process environment property accessor pattern
