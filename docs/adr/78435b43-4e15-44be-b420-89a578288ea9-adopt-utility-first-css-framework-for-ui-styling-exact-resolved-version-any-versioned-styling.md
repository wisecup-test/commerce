...
1. MUST: The exact resolved version of any versioned styling dependency MUST be verified via the project's lock file before implementation.

## Policy Block

- MUST The exact resolved version of any versioned styling dependency MUST be verified via the project's lock file before implementation.
