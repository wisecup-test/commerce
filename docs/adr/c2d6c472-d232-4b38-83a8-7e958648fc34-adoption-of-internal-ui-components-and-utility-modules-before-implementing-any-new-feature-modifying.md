...
1. MUST: Before implementing any new feature or modifying an existing one that relies on external dependencies, developers MUST discover the ecosystem's lock file and resolve the exact locked version of each dependency.

## Policy Block

- MUST Before implementing any new feature or modifying an existing one that relies on external dependencies, developers MUST discover the ecosystem's lock file and resolve the exact locked version of each dependency.
