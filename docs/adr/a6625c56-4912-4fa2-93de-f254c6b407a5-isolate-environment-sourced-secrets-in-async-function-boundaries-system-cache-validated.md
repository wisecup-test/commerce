...
1. MAY: The system MAY cache validated secret references within a single request context to avoid repeated environment access, provided the cache is scoped to the request lifecycle.

## Policy Block

- MAY The system MAY cache validated secret references within a single request context to avoid repeated environment access, provided the cache is scoped to the request lifecycle.
