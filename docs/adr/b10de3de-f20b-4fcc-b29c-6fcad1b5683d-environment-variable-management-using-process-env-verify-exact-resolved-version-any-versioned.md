...
1. MUST: MUST verify the exact resolved version of any versioned library or framework used in conjunction with environment variables by inspecting the project's lock file before implementation.

## Policy Block

- MUST MUST verify the exact resolved version of any versioned library or framework used in conjunction with environment variables by inspecting the project's lock file before implementation.
