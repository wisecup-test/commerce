...
1. MUST: All new UI features and modifications to existing ones MUST utilize the established internal UI components and utility modules for common patterns and functionalities.
