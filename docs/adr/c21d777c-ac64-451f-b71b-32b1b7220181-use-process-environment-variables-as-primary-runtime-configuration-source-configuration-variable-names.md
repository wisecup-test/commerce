...
1. MUST: Configuration variable names SHALL use uppercase with underscore separators to distinguish environment variables from code identifiers

## Policy Block

- MUST Configuration variable names SHALL use uppercase with underscore separators to distinguish environment variables from code identifiers
