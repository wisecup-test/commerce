...
1. MUST: Configuration keys accessed from the process environment MUST use consistent naming conventions that clearly identify the configuration domain and purpose.

## Policy Block

- MUST Configuration keys accessed from the process environment MUST use consistent naming conventions that clearly identify the configuration domain and purpose.
