...
1. MUST: Modules consuming configuration values MUST access them directly from the process environment at point of use

## Policy Block

- MUST Modules consuming configuration values MUST access them directly from the process environment at point of use
