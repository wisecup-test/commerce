...
1. SHOULD: Query parameter names for filtering, sorting, or other stateful UI elements SHOULD be consistently named across the application.

## Policy Block

- SHOULD Query parameter names for filtering, sorting, or other stateful UI elements SHOULD be consistently named across the application.
