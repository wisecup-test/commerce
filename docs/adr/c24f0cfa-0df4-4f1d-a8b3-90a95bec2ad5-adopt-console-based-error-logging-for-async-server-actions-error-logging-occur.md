...
1. MUST: Error logging MUST occur within catch blocks of try-catch statements wrapping async operations

## Policy Block

- MUST Error logging MUST occur within catch blocks of try-catch statements wrapping async operations
