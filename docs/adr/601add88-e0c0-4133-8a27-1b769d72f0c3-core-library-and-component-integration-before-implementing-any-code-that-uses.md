...
1. MUST: Before implementing any code that uses a versioned library, the exact resolved version MUST be identified from the project's lock file and its official documentation consulted.

## Policy Block

- MUST Before implementing any code that uses a versioned library, the exact resolved version MUST be identified from the project's lock file and its official documentation consulted.
