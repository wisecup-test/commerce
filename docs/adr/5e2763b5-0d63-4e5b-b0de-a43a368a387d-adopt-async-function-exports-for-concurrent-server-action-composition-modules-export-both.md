...
1. MAY: Modules may export both high-level async orchestration functions and lower-level async primitives to support composition at multiple abstraction levels.

## Policy Block

- MAY Modules may export both high-level async orchestration functions and lower-level async primitives to support composition at multiple abstraction levels.
