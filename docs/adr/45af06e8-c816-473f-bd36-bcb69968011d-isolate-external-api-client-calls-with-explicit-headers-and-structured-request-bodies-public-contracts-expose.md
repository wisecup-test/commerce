...
1. SHOULD: Public API contracts SHOULD expose domain operations as named functions that encapsulate client implementation details.

## Policy Block

- SHOULD Public API contracts SHOULD expose domain operations as named functions that encapsulate client implementation details.
