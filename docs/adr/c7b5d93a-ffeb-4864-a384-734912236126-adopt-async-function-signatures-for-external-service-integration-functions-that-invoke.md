...
1. MUST: Functions that invoke async operations MUST await the resolution of Promise values before consuming the result

## Policy Block

- MUST Functions that invoke async operations MUST await the resolution of Promise values before consuming the result
