...
1. MUST: API modules that construct external client requests with authentication headers shall receive secret values as function parameters or injected dependencies, not by direct environment variable access.

## Policy Block

- MUST API modules that construct external client requests with authentication headers shall receive secret values as function parameters or injected dependencies, not by direct environment variable access.
