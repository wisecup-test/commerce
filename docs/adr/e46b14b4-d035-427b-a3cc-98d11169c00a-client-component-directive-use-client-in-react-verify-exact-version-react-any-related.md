...
1. MUST: Verify the exact version of React and any related rendering framework from the project's lock file before implementing or modifying client components.

## Policy Block

- MUST Verify the exact version of React and any related rendering framework from the project's lock file before implementing or modifying client components.
