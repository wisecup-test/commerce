# Adopt Async Function Exports as Standard Concurrency Model for Server Components and Actions: Async Functions Pass
...
1. MAY: Async functions MAY pass Promise objects to context providers when immediate resolution is not required for rendering

## Policy Block

- MAY Async functions MAY pass Promise objects to context providers when immediate resolution is not required for rendering
