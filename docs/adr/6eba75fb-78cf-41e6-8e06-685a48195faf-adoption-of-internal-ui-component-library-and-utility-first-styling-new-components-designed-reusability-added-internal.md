# Adoption of Internal UI Component Library and Utility-First Styling: New Components Designed Reusability Added Internal
...
1. SHOULD: New UI components SHOULD be designed for reusability and added to the internal UI component library where appropriate.

## Policy Block

- SHOULD New UI components SHOULD be designed for reusability and added to the internal UI component library where appropriate.
