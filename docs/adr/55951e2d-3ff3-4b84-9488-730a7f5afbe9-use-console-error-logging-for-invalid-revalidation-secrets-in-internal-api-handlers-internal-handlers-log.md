...
1. MUST: Internal API handlers MUST log invalid revalidation secret attempts using console error output

## Policy Block

- MUST Internal API handlers MUST log invalid revalidation secret attempts using console error output
