...
1. MAY: Configuration modules may cache validated secret values for the lifetime of the process to avoid repeated environment lookups.

## Policy Block

- MAY Configuration modules may cache validated secret values for the lifetime of the process to avoid repeated environment lookups.
