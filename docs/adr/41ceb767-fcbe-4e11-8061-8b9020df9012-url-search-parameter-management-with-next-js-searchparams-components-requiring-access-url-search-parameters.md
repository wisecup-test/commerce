...
1. MUST: All components requiring access to URL search parameters MUST utilize the `searchParams` object provided by Next.js navigation hooks or `req.nextUrl.searchParams` in server-side contexts.

## Policy Block

- MUST All components requiring access to URL search parameters MUST utilize the `searchParams` object provided by Next.js navigation hooks or `req.nextUrl.searchParams` in server-side contexts.
