...
1. MUST: UI components MUST apply styling using utility classes assigned to the `className` attribute.

## Policy Block

- MUST UI components MUST apply styling using utility classes assigned to the `className` attribute.
