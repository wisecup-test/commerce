...
1. MUST: Environment variable access SHALL use the standard property access pattern on the process environment object

## Policy Block

- MUST Environment variable access SHALL use the standard property access pattern on the process environment object
