...
1. MUST_NOT: Synchronous blocking operations MUST NOT be used for network I/O, external service calls, or runtime context access in request-handling paths

## Policy Block

- MUST_NOT Synchronous blocking operations MUST NOT be used for network I/O, external service calls, or runtime context access in request-handling paths
