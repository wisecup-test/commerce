...
1. SHOULD: Async functions accessing request-scoped context (cookies, headers) should await the context accessor before dereferencing properties to prevent race conditions.

## Policy Block

- SHOULD Async functions accessing request-scoped context (cookies, headers) should await the context accessor before dereferencing properties to prevent race conditions.
