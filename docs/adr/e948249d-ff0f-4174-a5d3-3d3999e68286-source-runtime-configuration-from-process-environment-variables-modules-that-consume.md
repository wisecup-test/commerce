...
1. SHOULD: Modules that consume configuration values SHOULD validate the presence and format of required environment variables at the point of use or during application initialization.

## Policy Block

- SHOULD Modules that consume configuration values SHOULD validate the presence and format of required environment variables at the point of use or during application initialization.
