...
1. MUST: All public API contracts that perform server-side operations SHALL be exported as async functions with descriptive names reflecting their intent.

## Policy Block

- MUST All public API contracts that perform server-side operations SHALL be exported as async functions with descriptive names reflecting their intent.
