...
1. SHOULD: Modules requiring configuration values SHOULD access them at the point of use rather than caching them at module initialization

## Policy Block

- SHOULD Modules requiring configuration values SHOULD access them at the point of use rather than caching them at module initialization
