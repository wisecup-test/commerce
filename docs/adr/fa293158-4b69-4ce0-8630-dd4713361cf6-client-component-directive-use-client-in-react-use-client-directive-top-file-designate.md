...
1. MUST: Use the "use client" directive at the top of a file to designate a component as a client component when it requires client-side interactivity, state, or browser APIs.

## Policy Block

- MUST Use the "use client" directive at the top of a file to designate a component as a client component when it requires client-side interactivity, state, or browser APIs.
