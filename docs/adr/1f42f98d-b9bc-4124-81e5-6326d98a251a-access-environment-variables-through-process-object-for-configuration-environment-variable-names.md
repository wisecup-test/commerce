...
1. MUST: Environment variable names for secrets SHALL use uppercase naming with underscore separators

## Policy Block

- MUST Environment variable names for secrets SHALL use uppercase naming with underscore separators
