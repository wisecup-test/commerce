...
1. MUST: The "use client" directive MUST be placed before any imports or other code in the file.

## Policy Block

- MUST The "use client" directive MUST be placed before any imports or other code in the file.
