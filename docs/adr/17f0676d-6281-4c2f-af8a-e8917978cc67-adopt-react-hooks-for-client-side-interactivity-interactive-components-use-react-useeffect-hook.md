...
1. MUST: Interactive UI components MUST use React's `useEffect` hook for handling side effects.

## Policy Block

- MUST Interactive UI components MUST use React's `useEffect` hook for handling side effects.
