...
1. SHOULD: Server-side request context SHOULD be accessed through framework-provided async accessors to maintain separation from business logic.

## Policy Block

- SHOULD Server-side request context SHOULD be accessed through framework-provided async accessors to maintain separation from business logic.
