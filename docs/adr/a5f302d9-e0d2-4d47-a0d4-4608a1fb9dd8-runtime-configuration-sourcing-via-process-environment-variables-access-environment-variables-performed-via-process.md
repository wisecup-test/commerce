...
1. MUST: Access to environment variables MUST be performed via the `process.env` object.

## Policy Block

- MUST Access to environment variables MUST be performed via the `process.env` object.
