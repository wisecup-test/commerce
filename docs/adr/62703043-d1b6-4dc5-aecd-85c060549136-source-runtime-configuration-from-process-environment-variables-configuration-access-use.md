...
1. MUST: Configuration access MUST use direct property access on the environment object without intermediate caching layers at module initialization time.

## Policy Block

- MUST Configuration access MUST use direct property access on the environment object without intermediate caching layers at module initialization time.
