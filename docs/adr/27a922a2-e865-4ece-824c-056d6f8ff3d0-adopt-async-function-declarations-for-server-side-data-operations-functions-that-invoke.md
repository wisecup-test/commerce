...
1. MUST: Functions that invoke external HTTP APIs, read from the file system, or access runtime request context MUST use await to unwrap Promise results.

## Policy Block

- MUST Functions that invoke external HTTP APIs, read from the file system, or access runtime request context MUST use await to unwrap Promise results.
