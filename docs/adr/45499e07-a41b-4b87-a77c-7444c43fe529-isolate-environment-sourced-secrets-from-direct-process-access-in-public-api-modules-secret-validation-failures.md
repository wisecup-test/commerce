...
1. SHOULD: Secret validation failures should produce structured error objects that identify the missing or invalid configuration key without exposing the secret value.

## Policy Block

- SHOULD Secret validation failures should produce structured error objects that identify the missing or invalid configuration key without exposing the secret value.
