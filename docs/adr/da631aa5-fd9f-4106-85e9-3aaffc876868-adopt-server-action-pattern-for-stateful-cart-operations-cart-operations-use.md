...
1. MUST: Cart operations MUST use cookie-based session identifiers to maintain cart state continuity across requests.

## Policy Block

- MUST Cart operations MUST use cookie-based session identifiers to maintain cart state continuity across requests.
