...
1. MAY: Pure computation functions that do not perform I/O MAY use synchronous signatures even when called from async contexts

## Policy Block

- MAY Pure computation functions that do not perform I/O MAY use synchronous signatures even when called from async contexts
