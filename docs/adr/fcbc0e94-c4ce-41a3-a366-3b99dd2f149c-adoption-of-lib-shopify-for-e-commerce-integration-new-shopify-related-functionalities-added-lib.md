...
1. MAY: New Shopify-related functionalities MAY be added to `lib/shopify` following existing patterns within the module.

## Policy Block

- MAY New Shopify-related functionalities MAY be added to `lib/shopify` following existing patterns within the module.
