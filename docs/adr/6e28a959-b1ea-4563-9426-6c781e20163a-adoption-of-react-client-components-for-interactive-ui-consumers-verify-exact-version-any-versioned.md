...
1. MUST: Consumers MUST verify the exact version of any versioned dependency by inspecting the project's lock file before implementation.

## Policy Block

- MUST Consumers MUST verify the exact version of any versioned dependency by inspecting the project's lock file before implementation.
