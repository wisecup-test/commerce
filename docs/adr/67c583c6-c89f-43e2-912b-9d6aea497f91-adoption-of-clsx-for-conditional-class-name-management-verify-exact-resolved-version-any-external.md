...
1. MUST: Verify the exact resolved version of any external library via the project's lock file before implementation.

## Policy Block

- MUST Verify the exact resolved version of any external library via the project's lock file before implementation.
