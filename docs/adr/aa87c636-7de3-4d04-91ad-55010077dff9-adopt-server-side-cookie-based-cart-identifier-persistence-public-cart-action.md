...
1. MUST: Public cart action contracts MUST expose addItem, removeItem, updateItemQuantity, redirectToCheckout, and createCartAndSetCookie operations

## Policy Block

- MUST Public cart action contracts MUST expose addItem, removeItem, updateItemQuantity, redirectToCheckout, and createCartAndSetCookie operations
