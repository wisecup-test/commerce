...
1. SHOULD: Environment variable names should follow a hierarchical naming convention that groups related configuration by service or subsystem

## Policy Block

- SHOULD Environment variable names should follow a hierarchical naming convention that groups related configuration by service or subsystem
