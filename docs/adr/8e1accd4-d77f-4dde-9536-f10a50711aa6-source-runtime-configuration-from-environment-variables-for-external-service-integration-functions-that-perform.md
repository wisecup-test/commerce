...
1. MUST: API functions that perform authenticated requests MUST retrieve configuration values at module scope or function scope, never as hardcoded literals

## Policy Block

- MUST API functions that perform authenticated requests MUST retrieve configuration values at module scope or function scope, never as hardcoded literals
