...
1. MUST: Configuration keys for external service credentials MUST follow a namespaced naming convention that identifies the service and credential type

## Policy Block

- MUST Configuration keys for external service credentials MUST follow a namespaced naming convention that identifies the service and credential type
