...
1. MUST: Import `fragments` modules using relative paths from consuming modules within the same logical domain.

## Policy Block

- MUST Import `fragments` modules using relative paths from consuming modules within the same logical domain.
