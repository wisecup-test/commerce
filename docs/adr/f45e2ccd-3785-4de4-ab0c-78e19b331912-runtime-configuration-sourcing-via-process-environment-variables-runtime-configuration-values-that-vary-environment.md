# Runtime Configuration Sourcing via Process Environment Variables: Runtime Configuration Values That Vary Environment
...
1. MUST: All runtime configuration values that vary by environment or contain sensitive information MUST be sourced from environment variables.

## Policy Block

- MUST All runtime configuration values that vary by environment or contain sensitive information MUST be sourced from environment variables.
