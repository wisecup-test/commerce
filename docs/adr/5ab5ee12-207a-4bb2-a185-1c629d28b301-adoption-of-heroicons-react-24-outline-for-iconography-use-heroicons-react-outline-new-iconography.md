...
1. MUST: Use @heroicons/react/24/outline for all new iconography in React components.

## Policy Block

- MUST Use @heroicons/react/24/outline for all new iconography in React components.
