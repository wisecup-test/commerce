...
1. MUST: Interactive UI components MUST use React's `useState` hook for managing local component state.

## Policy Block

- MUST Interactive UI components MUST use React's `useState` hook for managing local component state.
