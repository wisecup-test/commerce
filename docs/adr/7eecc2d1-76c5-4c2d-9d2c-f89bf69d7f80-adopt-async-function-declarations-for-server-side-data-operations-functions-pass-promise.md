...
1. MAY: Functions MAY pass Promise objects to child components or context providers without awaiting them, allowing the consumer to control resolution timing.

## Policy Block

- MAY Functions MAY pass Promise objects to child components or context providers without awaiting them, allowing the consumer to control resolution timing.
