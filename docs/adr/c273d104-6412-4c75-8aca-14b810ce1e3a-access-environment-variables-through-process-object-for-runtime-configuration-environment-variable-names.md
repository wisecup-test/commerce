...
1. SHOULD: Environment variable names should follow a consistent naming convention that clearly identifies the service or component they configure

## Policy Block

- SHOULD Environment variable names should follow a consistent naming convention that clearly identifies the service or component they configure
