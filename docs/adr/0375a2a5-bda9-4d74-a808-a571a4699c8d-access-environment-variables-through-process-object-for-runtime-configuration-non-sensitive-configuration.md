...
1. MAY: Non-sensitive configuration values such as site names and feature flags may be accessed through the same process environment mechanism for consistency

## Policy Block

- MAY Non-sensitive configuration values such as site names and feature flags may be accessed through the same process environment mechanism for consistency
