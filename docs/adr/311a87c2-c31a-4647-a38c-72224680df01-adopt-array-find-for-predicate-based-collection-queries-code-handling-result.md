...
1. MUST: Code handling the result of a find operation must account for the undefined return value when no element matches the predicate

## Policy Block

- MUST Code handling the result of a find operation must account for the undefined return value when no element matches the predicate
