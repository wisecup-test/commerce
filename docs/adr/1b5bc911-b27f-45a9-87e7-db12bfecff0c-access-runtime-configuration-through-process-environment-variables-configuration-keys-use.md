...
1. MUST: Configuration keys MUST use uppercase naming with underscore separators

## Policy Block

- MUST Configuration keys MUST use uppercase naming with underscore separators
