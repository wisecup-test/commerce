...
1. SHOULD: Sensitive configuration values SHOULD be distinguished from public metadata through naming conventions or validation

## Policy Block

- SHOULD Sensitive configuration values SHOULD be distinguished from public metadata through naming conventions or validation
