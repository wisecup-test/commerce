...
1. MUST: All runtime configuration values that vary across deployment environments or contain credentials SHALL be accessed through the process environment namespace.

## Policy Block

- MUST All runtime configuration values that vary across deployment environments or contain credentials SHALL be accessed through the process environment namespace.
