...
1. MUST: Async functions that invoke external service boundaries must wrap operations in try-catch blocks and log errors to the console error stream.

## Policy Block

- MUST Async functions that invoke external service boundaries must wrap operations in try-catch blocks and log errors to the console error stream.
