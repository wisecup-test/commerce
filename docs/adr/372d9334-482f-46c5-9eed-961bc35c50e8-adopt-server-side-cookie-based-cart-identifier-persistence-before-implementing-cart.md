...
1. MUST: Before implementing cart operations that depend on framework-specific cookie APIs, the consumer MUST discover the exact resolved versions of all server runtime dependencies from the project's lock or resolution artifact

## Policy Block

- MUST Before implementing cart operations that depend on framework-specific cookie APIs, the consumer MUST discover the exact resolved versions of all server runtime dependencies from the project's lock or resolution artifact
