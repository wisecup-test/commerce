...
1. MUST: All cart mutation operations (add, remove, update, checkout) MUST retrieve the cart identifier from cookie storage before executing state changes

## Policy Block

- MUST All cart mutation operations (add, remove, update, checkout) MUST retrieve the cart identifier from cookie storage before executing state changes
