...
1. MUST: Before implementing, the consumer MUST discover the project's dependency manifest and lock file to determine the exact resolved version of React and related libraries, and consult its official documentation.

## Policy Block

- MUST Before implementing, the consumer MUST discover the project's dependency manifest and lock file to determine the exact resolved version of React and related libraries, and consult its official documentation.
