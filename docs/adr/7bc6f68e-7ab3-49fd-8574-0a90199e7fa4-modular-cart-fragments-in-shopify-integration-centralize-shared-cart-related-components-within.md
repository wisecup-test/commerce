...
1. MUST: Centralize shared cart-related components within the `fragments/cart` module for use by `lib/shopify` components.

## Policy Block

- MUST Centralize shared cart-related components within the `fragments/cart` module for use by `lib/shopify` components.
