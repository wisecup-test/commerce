...
1. MUST: All runtime configuration values SHALL be read from process environment variables using the standard process environment accessor

## Policy Block

- MUST All runtime configuration values SHALL be read from process environment variables using the standard process environment accessor
