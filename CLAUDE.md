...
|---|---|
| `**/*` | `cross-cutting-` _(25 ADRs)_ |
| `components/**` | `components-` _(10 ADRs)_ |
| `app/**` | `app-` _(8 ADRs)_ |
| `components/layout/search/filter/**` | `components-layout-search-` _(5 ADRs)_ |
| `lib/shopify/**` | `lib-shopify-` _(4 ADRs)_ |
| `components/cart/**` | `components-cart-` _(3 ADRs)_ |
