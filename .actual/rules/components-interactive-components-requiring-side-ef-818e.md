...
- **R-REACT-HOOKS-001** MUST: Interactive UI components requiring side effects (e.g., data fetching, subscriptions, DOM manipulation) MUST utilize the `useEffect` hook from `react`.
