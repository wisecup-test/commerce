...
- **R-ADR-001** MUST: Declare client-side components with the `"use client"` directive when they require interactive features or hooks that are not supported in server components.
